...
?>
<body style="background-image: url('src/page.webp'); background-size: 100%; background-repeat: no-repeat;">
    ...
    <section id="counts" class="counts section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Temukan jurnal berkualitas tinggi seputar teknik elektro di sini. Jelajahi koleksi lengkap kami untuk pengetahuan terkini.</p>
          <p>Gunakan fitur pencarian kami untuk menemukan jurnal yang Anda butuhkan. Masukkan kata kunci atau topik yang ingin Anda telusuri. </p>
        </div>
