    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 footer-contact">
          <h3>Repository Teknik Elektro</h3>
          <p>
          Jl. Prof. Sudarto, Tembalang, Kec. Tembalang,<br>
          Kota Semarang, Jawa Tengah 50275 <br>
            <strong>Phone:</strong> (024) 7473417 <br>
            <strong>Email:</strong> repository@polines.ac.id<br>
          </p>
        </div>
        <div class="col-md-6 footer-newsletter">
          <h4>Join Our Newsletter</h4>
          <form action="" method="post" class="input-group">
            <input type="email" name="email" class="form-control border" aria-describedby="subscribe-addon">
            <button class="btn btn-primary" id="subscribe-addon">Subscribe</button>
          </form>
        </div>
      </div>
    </div>
  ...
  <div class="container d-md-flex py-4">
    <div class="me-md-auto text-center text-md-start">
      ...
      <div class="credits">
        ...
        Powered by <strong><span>OnePage</span></strong>
