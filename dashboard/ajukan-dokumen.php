...
?>
<title>Ajukan Dokumen - Repository Teknik Elektro Unsika</title>
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <form action="add-post-action" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
          <label for="inputKontributor" class="col-sm-3 col-form-label">Kontributor/Dosen Pembimbing</label>
          <div class="col-sm-9">
            <select class="form-select form-control" name="kontributor" id="inputKontributor">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" id="inputKeyword" name="keyword" required>
          </div>
        </div>
        <div class="row mb-3">
